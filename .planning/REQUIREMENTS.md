...
- [ ] **DISP-03**: User sees server files grouped by device name
...
- [ ] **DISP-06**: User sees an empty state message when no files exist
- [ ] **DISP-07**: User sees a loading indicator while files are being fetched
